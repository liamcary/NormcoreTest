...
public partial class AvatarModel : RealtimeModel {
    ...
    public delegate void PropertyChangedHandler<in T>(AvatarModel model, T value);
    ...
    public AvatarModel() : base(new MetaModel()) {
